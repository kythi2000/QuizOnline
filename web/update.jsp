<%-- 
    Document   : update
    Created on : Feb 18, 2021, 3:33:33 PM
    Author     : HP 840 G2
--%>
...
<html>
    ...
    <body style="margin: 15px">
        <h1 style="text-align: center">Update Question</h1>
        <form action="update" method="POST">
            ...
            <c:if test = "${not empty UpdateQuestionError.answerErr}">
                <font color="red">
                ${UpdateQuestionError.answerErr}
                </font>  <br>
            </c:if>
